...
import 'package:saglik_asistani/DoktorGirisModel.dart';
...
class doktorgiris extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<DoktorGirisModel>(
      create: (_) => DoktorGirisModel(),
                          ...
                          child: TextButton(
                            onPressed: () async {
                              ...
                              if (response.docs.isNotEmpty) {
                                // sayfaya yönlendirme
                                //signIn();
                                await context.read<DoktorGirisModel>().signIn(
