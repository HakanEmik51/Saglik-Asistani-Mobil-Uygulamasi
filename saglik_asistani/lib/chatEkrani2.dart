...
class chatEkrani2 extends StatefulWidget {
  final Kullanici chatUser;
  const chatEkrani2({
    super.key,
  ...
  @override
  State<chatEkrani2> createState() => _chatEkrani2State();
}

class _chatEkrani2State extends State<chatEkrani2> {
